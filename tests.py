...
@pt.mark.parametrize(
    ...
    [
        ...
        # assumed typing
        ('xxxxx', '0', 0, None, 0),
        ('xxxxx', '123.3', None, None, 123.3),
        ('xxxxx', '123.', None, None, '123.'),
        ('i', '0.0', None, None, 0.0),
        ('m', '0.', None, None, '0.'),
        ('xxxxxx', '.0', None, None, 0.0),
        ('g', 'True', None, None, True),
        ('a', 'tRuE', None, None, True),
        ('y', 'false', None, None, False),
        ('xxxxxx', 'fAlSe', None, None, False),
        ('L', '0', None, None, 0),
        ('O', '0', True, None, False),
        ('L', '0', False, None, False),
        ('xxxxxx', '0', None, bool, True),
        ('these', '0', None, int, 0),
        ('are', '0', 1.0, float, 0.0),
        ('mostly', '0', None, float, 0.0),
        ('unnecessary', 'true', None, str, 'true'),
        ('xxxxxx', 'test', True, None, ValueError),
